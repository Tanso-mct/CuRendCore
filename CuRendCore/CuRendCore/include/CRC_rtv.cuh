...
public:
    ...
    CRC_RENDER_TARGET_VIEW_DESC(std::unique_ptr<ICRCContainable>& resource) : resource_(resource) {}
...
public:
    ...
    virtual ~CRCRenderTargetView() override = default;
...
public:
    virtual ~CRCID3D11RenderTargetView() override = default;
