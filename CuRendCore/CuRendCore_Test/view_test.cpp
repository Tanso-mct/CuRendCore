...
TEST(CuRendCore, CreateShaderResourceView)
{
...
TEST(CuRendCore, CreateD3D11ShaderResourceView)
{
    std::unique_ptr<ICRCContainable> windowAttr;
    {
        // Create window factory.
...
TEST(CuRendCore, CreateRenderTargetView)
{
    std::unique_ptr<ICRCContainable> windowAttr;
    {
        // Create window factory.
...
TEST(CuRendCore, CreateD3D11RenderTargetView)
{
    std::unique_ptr<ICRCContainable> windowAttr;
    {
        // Create window factory.
...
TEST(CuRendCore, CreateDepthStencilView)
{
    std::unique_ptr<ICRCContainable> windowAttr;
    {
        // Create window factory.
...
TEST(CuRendCore, CreateD3D11DepthStencilView)
{
    std::unique_ptr<ICRCContainable> windowAttr;
    {
        // Create window factory.
